...
import type { Channel, ChannelList } from '../../../types';
...
describe('CreatorChannelList', () => {
  ...
  describe('Basic rendering', () => {
    it('should render the title', () => {
      ...
      render(<CreatorChannelList />);

      expect(screen.getByText('creator.channels.title')).toBeInTheDocument();
    });
    ...
    it('should render skip and join buttons', () => {
      ...
      expect(screen.getByText('creator.channels.button.skip')).toBeInTheDocument();
      expect(screen.getByText('creator.channels.button.join')).toBeInTheDocument();
    });
    ...
    it('should render search input', () => {
      ...
      expect(screen.getByPlaceholderText('creator.channels.toolbar.search.placeholder')).toBeInTheDocument();
    });
    ...
    it('should render table headers when channel list is loaded', () => {
      ...
      expect(screen.getByText('creator.channels.column.name')).toBeInTheDocument();
      expect(screen.getByText('creator.channels.column.users')).toBeInTheDocument();
      expect(screen.getByText('creator.channels.column.topic')).toBeInTheDocument();
    });
  });
  ...
  describe('Loading state', () => {
    it('should show loading message when channel list is not finished', () => {
      ...
      expect(screen.getByText('creator.channels.loading')).toBeInTheDocument();
    });
    ...
    it('should not show table when loading', () => {
      ...
      expect(screen.queryByText('creator.channels.column.name')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Channel list display', () => {
    ...
    it('should show no results message when channel list is empty', () => {
      ...
      expect(screen.getByText('creator.channels.toolbar.search.no.results')).toBeInTheDocument();
    });
  });
  ...
  describe('Search functionality', () => {
    it('should filter channels by name', () => {
      ...
      const searchInput = screen.getByPlaceholderText('creator.channels.toolbar.search.placeholder');
  ...
  describe('Join button', () => {
    it('should be disabled when no channels are selected', () => {
      ...
      const joinButton = screen.getByText('creator.channels.button.join');
    ...
    it('should call setCreatorCompleted when join is clicked', () => {
      setupMocks({
        channelList: [createChannelList({ name: '#general' })],
      });
      ...
      expect(settingsStore.setCreatorCompleted).toHaveBeenCalledWith(true);
    });
  });

  describe('Skip button', () => {
    it('should call setCreatorCompleted when clicked', () => {
      setupMocks();

      render(<CreatorChannelList />);

      const skipButton = screen.getByText('creator.channels.button.skip');
